    ...
    for (let i = 0; i < vis.length; i++) {
        {
            ...
            if (diagonal) {
                console.log("checking for diagonal walls!");
                checkDiagonalWalls(i, vis, algo);
            }
...
document.write('<script type="text/javascript" src="Javascript files/Single destination/A*_algo.js" ></script>');
